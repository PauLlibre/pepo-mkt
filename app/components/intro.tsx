...
export default function Intro() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center w-full px-4 sm:px-6 md:px-8 gap-8">
      <h1 className="text-2xl lg:pl-20 sm:text-justify sm:text-3xl md:text-4xl font-bold text-center md:text-left animate-slideFromLeft pt-8 sm:pt-12 md:pt-20 w-full md:w-3/4 leading-tight">
